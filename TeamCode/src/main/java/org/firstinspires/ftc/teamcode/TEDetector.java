...
public class TEDetector extends OpenCvPipeline {
   ...
   public Mat processFrame(Mat input)
   {
      ...
      {
         position = SkystoneLocation.RIGHT; // Record our analysis
      ...
      {
         position = SkystoneLocation.NONE; // Record our analysis
      ...
      {
         position = SkystoneLocation.LEFT; // Record our analysis
   ...
   public double region1value(){
      return avg1;
   }
   public double region2value(){
      return avg2;
   }
}