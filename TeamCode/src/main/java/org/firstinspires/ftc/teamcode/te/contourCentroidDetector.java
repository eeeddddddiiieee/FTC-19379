...
public class contourCentroidDetector extends OpenCvPipeline {
    ...
    public contourCentroidDetector(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
